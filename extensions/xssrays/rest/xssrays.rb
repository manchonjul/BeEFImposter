      ...
      class XssraysRest < BeEF::Core::Router::Router
        ...
        post '/scan/:id' do
          begin
            ...
            # set cross_origin settings
            cross_origin = params[:cross_origin].to_s
            if cross_origin == ''
              cross_origin = cross_origin
            elsif cross_origin == 'false'
              cross_origin = false
            else
              cross_origin = true
            end
            ...
            xssrays_scan = XS.new(
              ...
              # check also cross_origin URIs found by the crawler
              :cross_origin => cross_origin,
            ...
            print_info("[XSSRays] Starting XSSRays [ip:#{hooked_browser.ip}], hooked domain [#{hooked_browser.domain}], cross-origin: #{cross_origin}, clean timeout: #{clean_timeout}")
